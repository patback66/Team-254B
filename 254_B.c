...
#pragma config(Motor,  port2,           bLeft,         tmotorVex393, openLoop, encoder, encoderPort, I2C_1, 1000)
...
#pragma config(Motor,  port7,           bRight,        tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_2, 1000)
